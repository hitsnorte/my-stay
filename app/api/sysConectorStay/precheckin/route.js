...
export async function POST(request) {
  try {
    ...
    const { protelReservationID, protelMpeHotel, propertyID } = body;

    if (!protelReservationID || !protelMpeHotel || !propertyID) {
    ...
    const response = await axios.post(url, null, {
      headers: {
        ...
        'ReservationID': protelReservationID,
        'MpeHotel': protelMpeHotel
      }
    });
